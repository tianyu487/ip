...
1. After that, locate the `src/main/java/littledaisy/LittleDaisy.java` file, right-click it, and choose `Run LittleDaisy.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is correct, you should see the littleDaisy banner in the output.
